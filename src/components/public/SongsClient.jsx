  ...
  return (
    <div className="flex flex-col relative">
      ...
      {activeSong && (
        ...
        >
          <div
            className="relative w-full max-w-4xl bg-gradient-to-b from-gray-900 via-gray-950 to-black border border-[#0ea5e9]/50 rounded-3xl shadow-[0_0_80px_rgba(14,165,233,0.35)] overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Hardware Corner Screws */}
            <div className="absolute top-3 left-3 z-30 w-4 h-4 rounded-full bg-gray-950 border border-white/20 flex items-center justify-center text-white/30 text-[9px]">+</div>
            <div className="absolute top-3 right-12 z-30 w-4 h-4 rounded-full bg-gray-950 border border-white/20 flex items-center justify-center text-white/30 text-[9px]">+</div>

            {/* Close Button */}
            <button
              onClick={() => setActiveSong(null)}
              className="absolute top-4 right-4 z-40 w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center transition-colors cursor-pointer"
              title="Close Player"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="p-6 md:p-8 border-b border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <Link
                ...
                onClick={() => setActiveSong(null)}
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0ea5e9] text-white font-mono text-xs font-bold uppercase tracking-wider hover:bg-[#0ea5e9]/90 transition-all shadow-[0_0_20px_#0ea5e9]"
              >
            ...
            <div className="p-6 md:p-8 bg-black/60">
              {getYouTubeEmbedUrl(activeSong.youtubeUrl) ? (
                <div className="relative aspect-video w-full rounded-2xl overflow-hidden border border-white/15 shadow-2xl bg-black">
                  <iframe
                ...
                <div className="p-8 rounded-2xl bg-gradient-to-b from-gray-900 to-black border border-white/10 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    <button
                      ...
                      className="w-14 h-14 rounded-full bg-[#0ea5e9] text-white flex items-center justify-center shadow-[0_0_25px_#0ea5e9] hover:scale-105 transition-transform cursor-pointer"
                    >
                    ...
                    <div className="text-left font-mono">
                      ...
                      <div className="text-sm text-white font-bold">{isPlayingDemo ? 'PLAYING MASTER STREAM...' : 'PAUSED'}</div>
                    </div>
                  </div>
                  ...
                  {activeSong.spotifyUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white text-xs font-mono font-bold transition-colors mt-2"
                    >
                  ...
                  {activeSong.contributions.map((credit, idx) => {
                    ...
                    return (
                      <Link
                        ...
                        onClick={() => setActiveSong(null)}
                        className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/5 hover:bg-[#0ea5e9]/20 border border-white/10 hover:border-[#0ea5e9]/40 transition-all group"
                      >
                        <span className="w-2 h-2 rounded-full bg-[#0ea5e9]" />
                        <span className="text-sm font-bold text-white group-hover:text-[#0ea5e9] transition-colors">
                          {credit.name}
                        </span>
                        <span className="text-xs font-mono text-gray-400">({credit.role})</span>
                      </Link>
                    );
                  })}
                </div>
      ...
      {/* ═══════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════ */}
      <div className="bg-black/60 backdrop-blur-2xl rounded-3xl border border-white/10 p-6 md:p-8 mb-12 shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden">
        {/* Hardware Screws */}
        <div className="absolute top-3 left-3 w-4 h-4 rounded-full bg-gray-900 border border-white/20 flex items-center justify-center text-white/30 text-[9px]">+</div>
        <div className="absolute top-3 right-3 w-4 h-4 rounded-full bg-gray-900 border border-white/20 flex items-center justify-center text-white/30 text-[9px]">+</div>
        <div className="absolute bottom-3 left-3 w-4 h-4 rounded-full bg-gray-900 border border-white/20 flex items-center justify-center text-white/30 text-[9px]">+</div>
        <div className="absolute bottom-3 right-3 w-4 h-4 rounded-full bg-gray-900 border border-white/20 flex items-center justify-center text-white/30 text-[9px]">+</div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8 pb-6 border-b border-white/10 relative z-10">
          <div>
            ...
            <h3 className="text-2xl sm:text-3xl font-black text-white flex items-center gap-3 tracking-tight">
              STUDIO AUDIO VAULT
              <span className="text-xs font-mono px-3 py-1 rounded-full bg-white/10 text-cyan-300 border border-white/10">
          ...
          <div className="relative w-full lg:w-80">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 rounded-2xl bg-black/50 border border-white/15 focus:border-[#0ea5e9] text-white text-sm font-mono placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0ea5e9]/30 transition-all shadow-inner"
            />
          </div>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between w-full mb-2">
                  <tab.icon className={`w-5 h-5 ${isActive ? 'text-[#0ea5e9]' : 'text-gray-400 group-hover:text-white'}`} />
                  <span className={`text-[10px] font-mono px-2.5 py-0.5 rounded-full ${
                    isActive ? 'bg-[#0ea5e9] text-white font-bold shadow-[0_0_10px_#0ea5e9]' : 'bg-white/5 text-gray-400'
                  }`}>
                    {tab.count}
                  </span>
                </div>
                ...
                <div className={`w-full h-1 rounded-full mt-3 transition-all ${
                  isActive ? 'bg-[#0ea5e9] shadow-[0_0_10px_#0ea5e9]' : 'bg-white/5 group-hover:bg-white/20'
                }`} />
              </button>
            );
          })}
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 relative z-10 pt-2">
          ...
          <div className="flex items-center gap-2 overflow-x-auto max-w-full pb-2 md:pb-0 no-scrollbar">
            <span className="text-xs font-mono font-bold text-gray-400 uppercase tracking-widest flex items-center gap-1.5 shrink-0 mr-1">
          ...
          {/* View Mode Selector */}
          <div className="flex items-center gap-1 bg-black/60 p-1 rounded-xl border border-white/10 shrink-0 self-end md:self-auto">
            <button
      ...
      {filteredSongs.length === 0 ? (
        <div className="text-center py-28 rounded-3xl border border-white/10 bg-black/40 backdrop-blur-md relative overflow-hidden">
          ...
          <h4 className="text-2xl font-black text-white mb-2">NO TRACKS MATCHING SEARCH OR FILTER</h4>
          ...
          <button
            ...
            className="px-6 py-3 rounded-full bg-[#0ea5e9] text-white font-mono text-xs font-bold uppercase tracking-widest hover:bg-[#0ea5e9]/90 transition-all shadow-[0_0_20px_#0ea5e9] cursor-pointer"
          >
            RESET ALL FILTERS
          </button>
        </div>
          ...
          {filteredSongs.map((song) => {
            ...
            return (
              <div
                ...
                className="group relative bg-black/60 backdrop-blur-xl rounded-3xl border border-white/10 hover:border-[#0ea5e9]/60 p-6 transition-all duration-500 shadow-2xl overflow-hidden flex flex-col h-full justify-between cursor-pointer"
              >
                {/* Hardware Corner Screws */}
                <div className="absolute top-3 left-3 w-4 h-4 rounded-full bg-gray-900 border border-white/20 flex items-center justify-center text-white/30 text-[9px]">+</div>
                <div className="absolute top-3 right-3 w-4 h-4 rounded-full bg-gray-900 border border-white/20 flex items-center justify-center text-white/30 text-[9px]">+</div>
                ...
                <div>
                  ...
                  <div className="relative aspect-square w-full rounded-2xl bg-black/50 mb-6 overflow-hidden flex items-center justify-center border border-white/10 group-hover:border-[#0ea5e9]/40 transition-all">
                    ...
                    <div className="absolute -right-10 top-1/2 -translate-y-1/2 w-52 h-52 rounded-full bg-gradient-to-tr from-black via-gray-900 to-gray-800 border-4 border-gray-950 shadow-2xl flex items-center justify-center transition-all duration-700 group-hover:translate-x-3 group-hover:rotate-180">
                      <div className="w-20 h-20 rounded-full border border-white/15 flex items-center justify-center bg-[#0ea5e9]/20">
                    ...
                    {song.coverImage ? (
                      ...
                      <div className="relative z-10 w-full h-full bg-gradient-to-br from-gray-900 via-gray-950 to-black flex flex-col items-center justify-center p-6 text-center">
                    ...
                    {/* Format Badge */}
                    <div className="absolute top-3 left-3 z-20 px-3 py-1 rounded-lg bg-black/80 backdrop-blur-md border border-white/15 text-[10px] font-mono font-bold text-[#0ea5e9] uppercase tracking-wider">
                      {song.projectType === 'MUSIC_VIDEO' ? 'MUSIC VIDEO' : song.projectType === 'COMMERCIAL' ? 'COMMERCIAL SCORE' : 'AUDIO MASTER'}
                    </div>

                    {/* Hover Play Button */}
                    <div className="absolute inset-0 z-20 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-[2px]">
                      <div className="w-16 h-16 rounded-full bg-[#0ea5e9] text-white flex items-center justify-center shadow-[0_0_30px_#0ea5e9] transform scale-75 group-hover:scale-100 transition-transform">
                  ...
                  <h3 className="text-2xl font-black text-white tracking-tight mb-1.5 group-hover:text-[#0ea5e9] transition-colors line-clamp-1">
                    {title}
                  </h3>

                  <p className="text-gray-400 font-mono text-xs mb-4 flex items-center gap-1.5">
                ...
                <div className="pt-4 border-t border-white/10 flex items-center justify-between text-xs font-mono text-gray-400">
                  ...
                  <span className="text-white font-bold group-hover:text-[#0ea5e9] transition-colors flex items-center gap-1">
          ...
          {filteredSongs.map((song) => {
            ...
            return (
              <div
                key={song.id}
                onClick={(e) => handlePlaySong(e, song)}
                className="group relative flex flex-col bg-black/60 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/10 hover:border-[#0ea5e9]/60 shadow-xl transition-all duration-500 h-full justify-between cursor-pointer"
              >
                {/* Hardware Corner Screws */}
                ...
                {/* Top Badge */}
                <div className="absolute top-3 left-10 z-20 flex items-center gap-1.5 px-3 py-1 rounded-full bg-black/80 backdrop-blur-md border border-white/15 text-[10px] font-mono font-bold text-white uppercase tracking-wider">
                ...
                {/* Cover Image */}
                <div className="relative aspect-[4/4] w-full overflow-hidden bg-black/40">
                  {song.coverImage ? (
                    <img
                      src={song.coverImage}
                      alt={title}
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-gray-900 to-black flex flex-col items-center justify-center p-6 text-center">
                      ...
                      <span className="text-[11px] font-mono font-bold text-white/50 tracking-widest uppercase">
                        STUDIO MASTER
                      </span>
                    </div>
                  )}
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div>
                    <div className="flex items-center justify-between text-[11px] font-mono text-gray-400 uppercase mb-2">
                  ...
                  <div className="pt-3 border-t border-white/10 flex items-center justify-between">
                    <span className="text-xs font-bold text-white/80 font-mono flex items-center gap-1.5">
        ...
        <div className="flex flex-col gap-3">
          {/* List Table Header */}
          <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-3 bg-black/40 rounded-xl border border-white/10 text-xs font-mono font-bold text-gray-400 uppercase tracking-wider">
          ...
          {filteredSongs.map((song, idx) => {
            ...
            return (
              <div
                key={song.id}
                onClick={(e) => handlePlaySong(e, song)}
                className="group relative grid grid-cols-1 md:grid-cols-12 gap-4 items-center bg-black/50 hover:bg-black/80 backdrop-blur-xl rounded-2xl border border-white/10 hover:border-[#0ea5e9]/60 p-4 transition-all duration-300 shadow-lg cursor-pointer"
              >
                {/* Track Channel Number */}
                <div className="col-span-1 flex items-center gap-3">
                  <span className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-xs font-mono font-bold text-gray-400 group-hover:border-[#0ea5e9] group-hover:text-[#0ea5e9] transition-colors">
                ...
                <div className="col-span-4 flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl overflow-hidden bg-gray-900 border border-white/10 shrink-0 relative">
                    {song.coverImage ? (
                  ...
                  <div className="min-w-0">
                    <h4 className="text-white font-black text-base truncate group-hover:text-[#0ea5e9] transition-colors">
                      {title}
                    </h4>
                ...
                {/* Artists */}
                <div className="col-span-3 text-sm text-gray-300 font-mono truncate">
                  {artistName}
                ...
                <div className="col-span-2 flex items-center gap-2">
                  <span className="px-2.5 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-cyan-300">
                    {song.genres?.[0] || 'Stereo Master'}
                  </span>
                </div>
                ...
                <div className="col-span-2 flex items-center justify-end">
                  <span className="px-4 py-2 rounded-xl bg-[#0ea5e9]/20 group-hover:bg-[#0ea5e9] text-[#0ea5e9] group-hover:text-white border border-[#0ea5e9]/40 text-xs font-mono font-bold transition-all flex items-center gap-1.5">
