...
export default async function ServicesPage({ params }) {
  ...
  return (
    <div className="min-h-screen bg-[#1a1022] pt-20">
      {/* Hero */}
      <section className="relative">
        <div className="flex flex-col items-center justify-center min-h-[60vh] w-full p-4 md:p-8">
          <div className="relative w-full max-w-7xl mx-auto rounded-2xl overflow-hidden min-h-[500px] flex items-center justify-center bg-[#1a1022]">
            {/* Decorative background glow */}
            <div className="absolute inset-0 bg-gradient-to-b from-[#9d2bee]/10 via-transparent to-[#1a1022]" />
            <div className="relative z-10 flex flex-col items-center text-center max-w-3xl px-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                <a
                  href="#services"
                  className="flex h-12 items-center justify-center rounded-full bg-[#9d2bee] px-8 text-base font-bold text-white transition-all hover:bg-[#9d2bee]/90 hover:scale-105 neon-glow"
                >
                  View Services
                </a>
                <Link
      ...
      <section id="services" className="relative py-20 px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div>
              <h2 className="text-[#9d2bee] font-bold text-sm tracking-widest uppercase mb-2">
                Our Expertise
              </h2>
          ...
          {services.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {services.map((svc) => (
                <div
                  key={svc.id}
                  className="group glass-panel rounded-[2rem] p-6 flex flex-col gap-4 transition-all duration-300 hover:-translate-y-2 hover:border-[#9d2bee]/30 hover:shadow-[0_0_25px_rgba(157,43,238,0.15)] cursor-pointer"
                >
                  <div className="w-14 h-14 rounded-2xl bg-[#9d2bee]/20 flex items-center justify-center text-[#9d2bee] mb-2">
                  ...
                  {svc.basePrice && (
                    <div className="pt-4 border-t border-white/5 flex items-center justify-between">
                      ...
                      <Link
                        ...
                        className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#9d2bee] hover:bg-[#9d2bee] hover:text-white transition-all"
                      >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="w-full grid md:grid-cols-2 gap-4">
              {pricing.map((item) => (
                <div
                  key={item.id}
                  className="flex items-center justify-between p-6 rounded-2xl border border-white/5 bg-[#1a1022] hover:border-[#9d2bee]/50 transition-colors"
                >
                  <div className="flex items-center gap-4">
                    <div className="bg-[#9d2bee]/20 text-[#9d2bee] p-3 rounded-full">
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#9d2bee]/15 rounded-full blur-[120px] pointer-events-none" />
        <div className="relative max-w-5xl mx-auto bg-[#241a2f] border border-white/5 rounded-3xl p-8 md:p-16 text-center shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/quote"
              className="flex h-14 items-center justify-center rounded-full bg-[#9d2bee] px-10 text-lg font-bold text-white transition-all hover:bg-[#9d2bee]/90 neon-glow"
            >
              Request a Quote
            </Link>
            <Link
