    ...
    <div className="min-h-screen bg-transparent pt-24">
      ...
      <section className="relative flex min-h-[75vh] w-full flex-col justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div className="h-full w-full bg-gradient-to-b from-[#0ea5e9]/10 via-[#0f172a] to-[#0f172a]" />
        </div>
        <div className="relative z-10 px-6 md:px-40 flex flex-1 flex-col justify-center items-center text-center">
          <div className="max-w-[800px] flex flex-col gap-6">
            <div className="flex justify-center mb-4">
              <span className="px-4 py-1.5 rounded-full border border-[#0ea5e9]/30 bg-[#0ea5e9]/10 text-[#0ea5e9] text-xs font-bold tracking-widest uppercase backdrop-blur-sm">
            ...
            <h1 className="text-white text-5xl md:text-7xl font-black leading-tight tracking-[-0.033em]">
              ...
              <span className="text-[#0ea5e9]">WE SCULPT SOUND.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
              <Link
                href="/songs"
                className="flex items-center justify-center rounded-full h-12 px-8 bg-[#0ea5e9] hover:bg-[#0ea5e9]/80 transition-all text-white text-base font-bold neon-glow"
              >
                View Our Work
              </Link>
              <Link
      ...
      <section className="py-20 px-6 md:px-20 bg-transparent">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex flex-col gap-2 mb-10">
            <h2 className="text-[22px] font-bold leading-tight tracking-widest uppercase text-[#0ea5e9]">
              The Architect
            </h2>
          ...
          <div className="glass-panel rounded-[2rem] p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#0ea5e9]/10 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2" />
            <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center relative z-10">
              {/* Portrait */}
              <div className="w-full md:w-1/3 flex-shrink-0">
                <div className="aspect-[3/4] rounded-2xl overflow-hidden relative shadow-2xl bg-[#334155]">
                  <img
                    src="/logo.PNG"
                    alt="Studio Founder"
                  ...
                  <div className="absolute bottom-6 left-6">
                    ...
                    <p className="text-[#0ea5e9] text-sm font-medium">Founder & Lead Engineer</p>
                  </div>
                </div>
              </div>
              {/* Bio */}
      ...
      <section className="py-20 px-6 md:px-20 bg-transparent">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Gear Card 1 */}
            <div className="group glass-panel p-6 rounded-2xl transition-all duration-300 hover:shadow-[0_0_15px_rgba(14, 165, 233,0.2)] hover:border-[#0ea5e9] cursor-pointer relative overflow-hidden">
              <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                <span className="material-symbols-outlined text-6xl text-white">mic</span>
              </div>
              <div className="flex flex-col gap-4 relative z-10">
                <div className="w-12 h-12 rounded-full bg-[#0ea5e9]/20 flex items-center justify-center text-[#0ea5e9] mb-2">
      ...
      {/* Sonic Palette */}
      <section className="py-20 px-6 md:px-20 glass-panel relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto relative z-10 text-center">
          <h2 className="text-[22px] font-bold leading-tight tracking-widest uppercase text-[#0ea5e9] mb-3">
            Sonic Palette
          </h2>
            ...
            {['Sinhala Pop', 'R&B / Soul', 'Hip-Hop', 'Cinematic Scores', 'Electronic', 'Classical', 'Baila'].map(
              (genre) => (
                <div key={genre} className="group cursor-pointer">
                  <div className="px-8 py-3 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm group-hover:bg-[#0ea5e9] group-hover:border-[#0ea5e9] transition-all duration-300">
      ...
      {/* Footer CTA */}
      <section className="py-20 px-6 md:px-20 glass-panel border-t border-white/10">
        <div className="max-w-[1200px] mx-auto flex flex-col items-center text-center gap-8">
          <h2 className="text-4xl md:text-6xl font-black text-white leading-tight">
            READY TO MAKE <br />
            <span className="text-[#0ea5e9]">HISTORY?</span>
          </h2>
          ...
          <Link
            href="/contact"
            className="flex items-center justify-center rounded-full h-16 px-12 bg-[#0ea5e9] hover:bg-[#0ea5e9]/90 transition-all text-white text-xl font-bold neon-glow shadow-2xl shadow-[#0ea5e9]/40 transform hover:-translate-y-1"
          >
            Book A Session
          </Link>
        </div>
